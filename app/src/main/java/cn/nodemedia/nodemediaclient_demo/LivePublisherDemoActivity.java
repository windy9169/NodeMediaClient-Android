...
public class LivePublisherDemoActivity extends AppCompatActivity implements View.OnClickListener, LivePublisherDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         * 16：9的分辨率就行，sdk自动切换。 fps 视频帧率 bitrate 视频码率 注意，sdk
         * 1.0.1以后，视频码率为最大码率，可以比以前的版本值高一点，编码器自动调节 avcProfile
         * 视频编码复杂度，高中低为三者比较相对而言。可根据应用场景选择 AVC_PROFILE_BASELINE 低CPU，低画质
         * AVC_PROFILE_MAIN 中CPU，中画质 AVC_PROFILE_HIGH 高CPU，高画质
         *
         * 以下建议分辨率及比特率 不用超过1280x720 320X180@15 ~~ 300kbps ~~ baseline 568x320@15
         * ~~ 400kbps ~~ baseline 640X360@15 ~~ 500kbps ~~ main 854x480@15 ~~
         * 600kbps ~~ main 960x540@15 ~~ 800kbps ~~ high 1280x720@15 ~~ 1000kbps
         * ~~ high
         */
        ...
        /**
         * 开始视频预览 cameraPreview ： 用以回显摄像头预览的GLSurfaceViewd对象，如果此参数传入null，则只发布音频
